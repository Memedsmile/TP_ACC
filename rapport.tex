...
\item Pour trouver une double etoile de cout min dans le Graphe, on va cree une instance G' qui est un \\
...
\item 
  ...
  \item
    On dit qu'il existe une réduction d'un problème P à un problème P' s'ilf existe une fonction f telle que x $\in$ D(P) <=> f(x) $\in$ D(P')\\
